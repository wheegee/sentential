...
root.add_typer(
    local, name="local", help="ops for {repository}", callback=require_sntl_file
)
root.add_typer(aws, name="aws", help="ops for {repository}", callback=require_sntl_file)
root.add_typer(
    secret, name="secret", help="for {repository}", callback=require_sntl_file
)
root.add_typer(
    config, name="config", help="for {repository}", callback=require_sntl_file
)
