...
def generate_manifest_list_distribution(image_manifest: dict, architecture: str = "amd64", os: str = "linux"):
    return {
...
def generate_image_manifest_list():
    ...
    arm_distribution = generate_manifest_list_distribution(arm_image_manifest, architecture="arm64")
    amd_distribution = generate_manifest_list_distribution(amd_image_manifest, architecture="amd64")
    manifest_list = {
