...
@pytest.mark.usefixtures("moto", "init", "ontology", "mock_repo", "aws_lambda_driver", "aws_ecr_driver")
class TestAwsLambdaDriver:
    ...
    def test_deploy(self, aws_lambda_driver: AwsLambdaDriver, aws_ecr_driver: AwsEcrDriver):
    ...
    def test_deploy_w_provisions(self, aws_lambda_driver: AwsLambdaDriver, aws_ecr_driver: AwsEcrDriver):
